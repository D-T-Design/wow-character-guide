export default function getGameData() {
  return {
		availableFactions: ["Horde", "Alliance"],
		hordeRaces: ["Undead", "Troll", "Tauren", "Orc", "Blood Elf"],
		allianceRaces: ["Human", "Night Elf", "Dwarf", "Gnome", "Draenei"],
		classes: [
			{
				id: "11",
				name: "Druid",
					...
					classGuides: {
						data: [
							...
							},
							{
								...
								thumb: "PVE-Balance-Druid-Boomkin-DPS-Guide-TBC-Burning-Crusade-Classic_uanvfx.jpg",
							},
						],
					},
					creators: {
			...
			},
			{
				...
				reference: {
					...
					secondarystats: ["spi", "spellhit", "spellhaste", "spellpower", "spellcrit"],
					...
					classGuides: {
						data: [
							...
							},
							{
								...
								thumb: "TBC-Classic-PVE-Fire-Mage-DPS-Guide-Burning-Crusade-Classic_o4ikb4.jpg",
							},
							{
					...
					classGuides: {
						data: [
							...
							},
							{
								...
								thumb: "wow-world-of-warcraft-troll-shaman-wallpaper-preview_humowe.jpg",
							},
							{
			...
			},
			{
				...
				reference: {
					...
					secondarystats: ["defense", "block", "expertise", "hit", "agi", "haste", "crit"],
		...
		undeadClasses: ["Mage", "Priest", "Rogue", "Warlock", "Warrior"],
		trollClasses: ["Hunter", "Mage", "Priest", "Rogue", "Shaman", "Warrior"],
		taurenClasses: ["Druid", "Hunter", "Shaman", "Warrior"],
		orcClasses: ["Hunter", "Rogue", "Shaman", "Warlock", "Warrior"],
		humanClasses: ["Mage", "Priest", "Rogue", "Warlock", "Warrior", "Paladin"],
		nightelfClasses: ["Druid", "Hunter", "Priest", "Rogue", "Warrior"],
		dwarfClasses: ["Hunter", "Priest", "Rogue", "Warrior", "Paladin"],
		gnomeClasses: ["Mage", "Rogue", "Warlock", "Warrior"],
		bloodelfClasses: ["Hunter", "Mage", "Priest", "Rogue", "Warlock", "Paladin"],
		draeneiClasses: ["Hunter", "Mage", "Priest", "Shaman", "Warrior", "Paladin"],
		druidRef: {
			summary:
				"One of three Hybrid classes, the Druid can heal, tank, melee DPS, or even cast spells.  This can be done thanks to Druid's unique skill: Shapeshifting.  When in bear form they are the second best tank in the game, and when healing they specialize in healing over time spells.  For damage dealing, cat form is used for melee damage.  Druids even have a dedicated form for ranged spellcasting Moonkin.",
			teamroles: ["Tank", "DPS", "Heal", "Crowd Control"],
			...
			classGuides: {
				data: [
					...
					},
					{
						title: "PvE Retribution Paladin Guide",
						link: "https://www.warcrafttavern.com/tbc/guides/pve-retribution-paladin/https://www.gnarlyguides.com/tbc/guides/pve-holy-paladin/",
						thumb: "TBC-Classic-PvE-Retribution-Paladin-Guide-Burning-Crusade-Classic_rxqmml.jpg",
					},
				],
			},
			creators: {
